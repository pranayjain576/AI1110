...
\textbf{Answer 12.13.1.4 :}
\\
Given, $2P(A)=P(B)=\frac{5}{13}$ , $P(A|B)=\frac{2}{5}$ \\
  $\Rightarrow$ $P(B)=\frac{5}{13}$ , $P(A)=\frac{5}{26}$ , $P(A|B)=\frac{2}{5}$ \\
...
$\Rightarrow$ $P(A \cup B)= \frac{5}{26} + \frac{5}{13} - \frac{2}{13} = \frac{5 + 10 - 4}{26} = \frac{15 -4 }{26} $\\
